...
# SOZLAMALAR
# ──────────────────────────────────────────
BOT_TOKEN      = "8284600998:AAG1PyHWzAF81Da2DbvHKwkqbUFeoKBx5hY"
ADMIN_ID       = 5492502957
...
async def cmd_start(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "📌 Istalgan havolani QR kodga aylantiring!\n\n"
        "🎁 *Chegirmalar:*\n"
        f"┣ ✅ Birinchi *{BEPUL_LIMIT} ta* QR — BEPUL\n"
        f"┗ 💵 Keyingisi — atigi *{NARX_SOM:,} so'm*\n\n"
        "━━━━━━━━━━━━━━━━━━━━━━\n"
...
async def on_callback(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "adm_panel" and uid == ADMIN_ID:
        await q.edit_message_text(
            "🛠 *Boshqaruv paneli*\n"
            "━━━━━━━━━━━━━━━━━━━━━━\n\n"
            "👨‍💼 Xush kelibsiz, Admin!\n"
    ...
    if data == "balance":
        ...
        await q.edit_message_text(
            ...
            f"🎁 Bepul QR: *{u['free_used']}/{BEPUL_LIMIT}* ishlatilgan\n"
            f"🔗 Qolgan bepul: *{max(0, BEPUL_LIMIT - u['free_used'])}* ta\n\n"
            "━━━━━━━━━━━━━━━━━━━━━━",
            parse_mode="Markdown",
    ...
    if data == "deposit":
        await q.edit_message_text(
            ...
            f"┗ 3️⃣ Chekni shu yerga yuboring\n\n"
            "⚡️ Admin tasdiqlashi bilan balans *avtomatik* to'ldiriladi!\n\n"
            "━━━━━━━━━━━━━━━━━━━━━━\n"
    ...
    if data == "adm_stats" and uid == ADMIN_ID:
        ...
        await q.edit_message_text(
            ...
            parse_mode="Markdown",
            reply_markup=InlineKeyboardMarkup([[
                InlineKeyboardButton("🔙 Admin Menyu", callback_data="adm_panel")
            ]])
        )
        return
...
async def on_message(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if ctx.user_data.get("waiting_receipt") and update.message.photo:
        ...
        caption = (
            ...
            "⬇️ Summani kiritib tasdiqlang yoki rad eting."
        )
                ...
                try:
                    await ctx.bot.send_message(
                        ...
                        text=f"✅ *To'lovingiz tasdiqlandi!*\n"
                             ...
                             "━━━━━━━━━━━━━━━━━━━━━━\n"
                             "🔗 Endi QR kod yaratishingiz mumkin!",
                        parse_mode="Markdown",
                        reply_markup=main_keyboard(target_id)
                    )
                except Exception:
